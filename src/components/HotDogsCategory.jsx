...
function HotDogsCategory() {
  ...
  // Filtered product data for the Cake category
  const products = [
  ...
  return (
    <Container className="mt-4">
      ...
      <span style={{ color: '#1D8348' }}>HotDogs</span> <span style={{ color: 'black' }}>Products</span>
      </h2>
      <Row>
...
export default HotDogsCategory;