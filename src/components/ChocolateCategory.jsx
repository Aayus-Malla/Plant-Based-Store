...
function ChocolateCategory() {
  ...
  // Filtered product data for the Chocolate category
  const products = [
  ...
  return (
    <Container className="mt-4">
      ...
      <span style={{ color: '#1D8348' }}>Chocolate</span> <span style={{ color: 'black' }}>Products</span>
      </h2>
      <Row>
...
export default ChocolateCategory;